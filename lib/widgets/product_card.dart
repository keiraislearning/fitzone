import 'package:fitzone/screens/login.dart';
          ...
          ScaffoldMessenger.of(context)
            ...
            if (item.name == "Tambah Produk") {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => ProductEntryListPage(filter: "all"),
                  ),
              );
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => ProductEntryListPage(filter: "my"),
              ),
            );
            } else if (item.name == "See Fitzone") {
              Navigator.push(
                  context,
                  MaterialPageRoute(
